...
<head>
    ...
    <title>Faculty & Student Login - I-Acadsikatayo: Learning Management System</title>
        ...
        <div class="login-form">
            ...
            <div class="form-card">
                <div class="form-header">
                    ...
                    <p>Access your educational dashboard</p>
                </div>
                ...
                <form method="POST" action="">
                    ...
                    <button type="submit" class="btn btn-primary" id="login-btn" disabled>
                        <i class="fas fa-sign-in-alt"></i> Select a Role to Continue
                    </button>
                </form>
    ...
    <script>
        ...
        roleBtns.forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                loginBtn.innerHTML = `<i class="fas fa-sign-in-alt"></i> Sign In as ${role.charAt(0).toUpperCase() + role.slice(1)}`;
                
                // Update button colors and icon based on role
                if (role === 'faculty') {
                    loginBtn.style.background = 'linear-gradient(135deg, #2563eb 0%, #1e40af 100%)';
                    formIcon.style.background = 'linear-gradient(135deg, #2563eb 0%, #1e40af 100%)';
                    formIcon.innerHTML = '<i class="fas fa-chalkboard-teacher"></i>';
                } else if (role === 'student') {
                    loginBtn.style.background = 'linear-gradient(135deg, #16a34a 0%, #15803d 100%)';
                    formIcon.style.background = 'linear-gradient(135deg, #16a34a 0%, #15803d 100%)';
                    formIcon.innerHTML = '<i class="fas fa-user-graduate"></i>';
                }
            });
        });
        ...
        document.querySelector('form').addEventListener('submit', function(e) {
            if (!selectedRoleInput.value) {
                e.preventDefault();
                alert('Please select your role (Faculty or Student)');
            }
        });
    </script>
</body>
