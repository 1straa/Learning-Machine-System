...
if (isset($_POST['confirm_delete'])) {
    ...
    if ($delete_stmt->execute()) {
        header('Location: admin_dashboard.php?tab=courses&success=course_deleted');
    } else {
        header('Location: admin_dashboard.php?tab=courses&error=delete_failed');
    }
    $delete_stmt->close();
    exit();
}
...
<head>
    ...
    <title>Delete Course - Admin Dashboard</title>
        ...
        <main class="main-content">
            ...
            <div class="content">
                <div class="content-section">
                    <p>Are you sure you want to delete the course <strong><?= htmlspecialchars($course['name']) ?></strong>? This action cannot be undone.</p>
                    <form method="POST" action="">
                        <button type="submit" name="confirm_delete" class="btn-danger">Yes, Delete Course</button>
                        <a href="admin_dashboard.php?tab=courses" class="btn-secondary">Cancel</a>
                    </form>
                </div>
            </div>
        </main>
